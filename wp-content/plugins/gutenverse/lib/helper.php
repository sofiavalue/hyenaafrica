...
if ( ! function_exists( 'gutenverse_global_font_style_generator' ) ) {
	...
	function gutenverse_global_font_style_generator( $fonts ) {
		...
		return 'body { ' . $variable_style['Desktop'] . ' } 
				@media only screen and (max-width: ' . gutenverse_breakpoint( 'Tablet' ) . ') { body {' . $variable_style['Tablet'] . '}
				@media only screen and (max-width: ' . gutenverse_breakpoint( 'Mobile' ) . ') { body {' . $variable_style['Mobile'] . '}';
	}
}
