		...
		foreach ( $this->generated as $device => $css ) {
			...
			if ( ! empty( $generated_device_style ) ) {
				if ( 'Desktop' === $device ) {
					...
					$generated_style[] = '@media only screen and (max-width: ' . gutenverse_breakpoint( 'Laptop' ) . ") { {$generated_device_style} }";
				} elseif ( 'Tablet' === $device ) {
					$generated_style[] = '@media only screen and (max-width: ' . gutenverse_breakpoint( 'Tablet' ) . ") { {$generated_device_style} }";
				} elseif ( 'Mobile' === $device ) {
					$generated_style[] = '@media only screen and (max-width: ' . gutenverse_breakpoint( 'Mobile' ) . ") { {$generated_device_style} }";
				}
			}
		}
